-- #####################################################################
-- #################### SCRIPT DE INSERCIÓN PERFECTO ###################
-- #####################################################################

-- SECCIÓN 1: Catálogos/Enums
...
-- MODIFICADO: 'Job' ahora solo contiene habilidades inherentes
...
-- NUEVO: 'Role' contiene los puestos dentro de una afiliación
...
-- SECCIÓN 2: Capítulos y Episodios
...
-- SECCIÓN 3: Uniones de apariciones
...
-- SECCIÓN 4: Entidades principales
...
-- SECCIÓN 5: Tablas de unión finales con lógica Job/Role corregida
...
(1, 1, 1, 1), -- Luffy, Straw Hats, Current, Captain
(2, 1, 1, 2), -- Zoro, Straw Hats, Current, First Mate
(3, 1, 1, 4), -- Sanji, Straw Hats, Current, Crewmate
(6, 3, 2, NULL), -- Mihawk, Warlords, Former, (no specific role)
(7, 2, 3, 1); -- Law, Red Hair Pirates (hypothetical), Allied, Captain
