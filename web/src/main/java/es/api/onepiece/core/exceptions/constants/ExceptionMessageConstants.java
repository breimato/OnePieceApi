...
public class ExceptionMessageConstants {
  ...
  public static final String CHARACTER_AFFILIATION_ROLE_MESSAGE_ERROR =
      "Error in Character Affiliation Role, Role should be CREWMATE, CAPTAIN or VICECAPTAIN";
  ...
  public static final String CHARACTER_AFFILIATION_STATUS_MESSAGE_ERROR =
      "Error in Character Affiliation Status, Status should be CURRENT, FORMER or ALLIED";
  ...
  public static final String CHARACTER_TITLE_MESSAGE_ERROR =
      "Error in Character Title, Title should be SHICHIBUKAI, YONKOU or SUPERNOVA";
  ...
  public static final String HAKI_TYPE_MESSAGE_ERROR =
      "Error in Haki Type, Type should be HAOSHOKU, BUSOSHOKU or KENBUNSHOKU";
  ...
  public static final String BOAT_TYPE_MESSAGE_ERROR =
      "Error in Boat Type, Type should be SLOOP, CARAVEL, BRIG, GALLEY, GALLEON, FRIGATE, SUBMARINE, RAFT or OTHER";
  ...
  public static final String SWORD_STATUS_MESSAGE_ERROR =
      "Error in Sword Status, Status should be NORMAL, GRADED, SUPREME_GRADE, BLACK_BLADE, CURSED, BROKEN or OTHER";
  ...
  public static final String SWORD_CATEGORY_MESSAGE_ERROR =
      "Error in Sword Category, Category should be SAIJO_O_WAZAMONO, O_WAZAMONO or WAZAMONO";
  ...
  public static final String FRUIT_TYPE_MESSAGE_ERROR =
      "Error in Fruit Type, Type should be PARAMECIA, LOGIA, ZOAN, MYTHICAL_ZOAN, ANCIENT_ZOAN or ARTIFICIAL_ZOAN";
