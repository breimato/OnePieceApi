...
public interface CharacterMyBatisMapper {
    ...
    /**
     * Unlinks the transformations by character id.
     *
     * @param characterId the character id
     */
    @Update("update transformation set character_id = null where character_id = #{characterId}")
    void unlinkTransformationsByCharacterId(Integer characterId);

    /**
     * Unlinks the attacks by character id.
     *
     * @param characterId the character id
     */
    @Update("update attack set character_id = null where character_id = #{characterId}")
    void unlinkAttacksByCharacterId(Integer characterId);
