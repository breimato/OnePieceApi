...
public interface CharacterMyBatisMapper {
    ...
    /**
     * Insert character titles in batch.
     *
     * @param characterId the character id
    ...
    @Insert("""
                <script>
                insert into character_title (character_id, title_id) VALUES
                <foreach collection='titleIds' item='titleId' separator=','>
                    (#{characterId}, #{titleId})
                </foreach>
                </script>
            """)
    void insertTitles(@Param("characterId") Integer characterId,
            @Param("titleIds") List<Integer> titleIds);

    /**
     * Insert character jobs in batch.
     *
     * @param characterId the character id
    ...
    @Insert("""
            ...
            """)
    void insertJobs(@Param("characterId") Integer characterId,
    ...
    @Insert("""
                ...
                <foreach collection='affiliations' item='aff' separator=','>
                    (#{characterId}, #{aff.affiliationId}, #{aff.statusId}, #{aff.roleId})
                </foreach>
                </script>
            """)
    ...
    @Insert("""
                <script>
                insert into character_sword (character_id, sword_id) VALUES
                <foreach collection='swordIds' item='swordId' separator=','>
                    (#{characterId}, #{swordId})
                </foreach>
                </script>
            """)
    void insertSwords(@Param("characterId") Integer characterId,
            @Param("swordIds") List<Integer> swordIds);

    /**
     * Insert character transformations in batch.
     *
     * @param characterId       the character id
    ...
    @Update("""
                <script>
                update transformation set character_id = #{characterId}
                where transformation_id in
                <foreach collection='transformationIds' item='id' open='(' separator=',' close=')'>
                    #{id}
                </foreach>
                </script>
            """)
    void insertTransformations(@Param("characterId") Integer characterId,
            @Param("transformationIds") List<Integer> transformationIds);

    /**
     * Insert character attacks in batch.
     *
     * @param characterId the character id
    ...
    @Update("""
                <script>
                update attack set character_id = #{characterId}
                where attack_id in
                <foreach collection='attackIds' item='id' open='(' separator=',' close=')'>
                    #{id}
                </foreach>
                </script>
            """)
    void insertAttacks(@Param("characterId") Integer characterId,
            @Param("attackIds") List<Integer> attackIds);
    ...
    @Result(property = "status", column = "name")
    @Select("select id, name from character_status where id = #{id}")
    ...
    @Result(property = "description", column = "description")
    @Result(property = "debut", column = "first_appearance_id", one = @One(select = "getDebutById"))
    @Result(property = "character", column = "character_id", one = @One(select = "getCharacterSummaryById"))
    ...
    @Select("""
            ...
            where c.character_id = #{id}
            """)
    CharacterSummaryEntity getCharacterSummaryById(Integer id);

    /**
     * Deletes the fruits by character id.
     *
     * @param characterId the character id
     */
    @Delete("delete from character_fruit where character_id = #{characterId}")
    void deleteFruitsByCharacterId(Integer characterId);

    /**
     * Deletes the hakis by character id.
     *
     * @param characterId the character id
     */
    @Delete("delete from character_haki where character_id = #{characterId}")
    void deleteHakisByCharacterId(Integer characterId);

    /**
     * Deletes the titles by character id.
     *
     * @param characterId the character id
     */
    @Delete("delete from character_title where character_id = #{characterId}")
    void deleteTitlesByCharacterId(Integer characterId);

    /**
     * Deletes the jobs by character id.
     *
     * @param characterId the character id
     */
    @Delete("delete from character_job where character_id = #{characterId}")
    void deleteJobsByCharacterId(Integer characterId);

    /**
     * Deletes the affiliations by character id.
     *
     * @param characterId the character id
     */
    @Delete("delete from character_affiliation where character_id = #{characterId}")
    void deleteAffiliationsByCharacterId(Integer characterId);

    /**
     * Deletes the swords by character id.
     *
     * @param characterId the character id
     */
    @Delete("delete from character_sword where character_id = #{characterId}")
    void deleteSwordsByCharacterId(Integer characterId);

    /**
     * Deletes the transformations by character id.
     *
     * @param characterId the character id
     */
    @Delete("delete from transformation where character_id = #{characterId}")
    void deleteTransformationsByCharacterId(Integer characterId);

    /**
     * Deletes the attacks by character id.
     *
     * @param characterId the character id
     */
    @Delete("delete from attack where character_id = #{characterId}")
    void deleteAttacksByCharacterId(Integer characterId);
     ...
     * @param characterId the character id
     */
    @Delete("delete from \"character\" where character_id = #{characterId}")
