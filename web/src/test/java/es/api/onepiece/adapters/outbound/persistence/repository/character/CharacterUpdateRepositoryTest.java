...
class CharacterUpdateRepositoryTest {
        ...
        void testExecute_whenVoHasAllFields_thenUpdatesCharacterAndRelations() {
                ...
                verify(this.characterMyBatisMapper, times(1))
                                .deleteTransformationsByCharacterId(updateCharacterVo.getId());
                ...
                verify(this.characterMyBatisMapper, times(1)).deleteAttacksByCharacterId(updateCharacterVo.getId());
        ...
        void testExecute_whenPartialUpdate_thenSuccess() {
                ...
                verify(this.characterMyBatisMapper, times(0)).deleteTransformationsByCharacterId(any());
                verify(this.characterMyBatisMapper, times(0)).insertTransformations(any(), any());

                verify(this.characterMyBatisMapper, times(0)).deleteAttacksByCharacterId(any());
